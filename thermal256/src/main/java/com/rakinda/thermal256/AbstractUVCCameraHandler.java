...
import com.rakinda.thermal256.encoder.MediaMuxerWrapper;
import com.rakinda.thermal256.encoder.MediaSurfaceEncoder;
import com.rakinda.thermal256.encoder.MediaVideoBufferEncoder;
...
//			mUVCCamera.startCapture();
			...
			boolean isT3 = DeviceName.deviceName.contains("DL")|| DeviceName.deviceName.contains("DV");
			if(isT3){
